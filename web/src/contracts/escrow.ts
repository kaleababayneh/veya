...
export type DataKey = {tag: "Config", values: void} | {tag: "Tokens", values: void} | {tag: "DkimKeys", values: void} | {tag: "Domains", values: void} | {tag: "AdCount", values: void} | {tag: "Ad", values: readonly [u64]} | {tag: "ReservationCount", values: void} | {tag: "Reservation", values: readonly [u64]} | {tag: "Nullifier", values: readonly [Buffer]} | {tag: "ActiveCount", values: readonly [string]};
...
export interface Client {
  ...
  /**
   * Construct and simulate a domains transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Accepted bank domain hashes: `Config.domain_hash` plus the extra ones set with `set_domains`.
   */
  domains: (options?: MethodOptions) => Promise<AssembledTransaction<Array<Buffer>>>
  ...
  /**
   * Construct and simulate a set_domains transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  set_domains: ({domains}: {domains: Array<Buffer>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        ...
        "AAAAAAAAAF1BY2NlcHRlZCBiYW5rIGRvbWFpbiBoYXNoZXM6IGBDb25maWcuZG9tYWluX2hhc2hgIHBsdXMgdGhlIGV4dHJhIG9uZXMgc2V0IHdpdGggYHNldF9kb21haW5zYC4AAAAAAAAHZG9tYWlucwAAAAAAAAAAAQAAA+oAAAPuAAAAIA==",
        ...
        "",
  ...
  public readonly fromJSON = {
    quote: this.txFromJSON<Result<u64>>,
        ...
        domains: this.txFromJSON<Array<Buffer>>,
        ...
        set_domains: this.txFromJSON<Result<void>>,
