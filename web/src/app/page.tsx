...
/** A brand mark on a small white disc, the way the app's dropdowns show them (reads on both themes). */
const Logo = ({ src, alt }: { src: string; alt: string }) => <span className="veya-logo"><Image src={src} alt={alt} width={30} height={30} unoptimized /></span>;
const XLM = "/tokens/xlm.svg", USDC = "/tokens/usdc.svg", ZIRAAT = "/banks/00010-mark.svg", VAKIF = "/banks/00015-mark.svg";
export default function Home() {
  return <VeyaMotion>
    <div className="veya-first">
    <section className="veya-hero" aria-labelledby="hero-title">
      ...
      <div className="hero-copy">
        ...
        <Link href="/market" className="veya-button">Launch app <Arrow /></Link>
      </div>
    ...
    <div className="veya-rail"><span className="rail-side"><span className="veya-logos"><Logo src={ZIRAAT} alt="Ziraat Bankası" /><Logo src={VAKIF} alt="VakıfBank" /></span><span>Turkish lira in.</span></span><span className="rail-line" /><span className="rail-side"><span>USDC or XLM out.</span><span className="veya-logos"><Logo src={USDC} alt="USDC" /><Logo src={XLM} alt="Stellar Lumens (XLM)" /></span></span><span className="rail-note">One peer-to-peer exchange.</span></div>
    </div>
    ...
    <section className="veya-story section-width" aria-label="How Veya works">
      <article className="story-panel story-choose" data-reveal>
        <div className="story-copy"><span className="step-number">01 / CHOOSE</span><h2>Find your<br />starting point.</h2><p>Choose a peer’s offer.<br />See the price before you reserve.</p><div className="veya-chips" aria-label="Assets on offer"><span className="veya-chip"><Logo src={USDC} alt="" />USDC</span><span className="veya-chip"><Logo src={XLM} alt="" />XLM</span></div><Link className="veya-button ghost" href="/market">Find an offer <Arrow /></Link></div>
      ...
      <article className="story-panel story-transfer" data-reveal>
        <div className="story-copy"><span className="step-number">02 / TRANSFER</span><h2>Same bank.<br />New possibilities.</h2><p>Pay the seller by FAST from Ziraat<br />or VakıfBank. Keep the receipt email.</p><div className="veya-chips" aria-label="Supported banks"><span className="veya-chip"><Logo src={ZIRAAT} alt="" />Ziraat Bankası</span><span className="veya-chip"><Logo src={VAKIF} alt="" />VakıfBank</span></div><Link className="text-link" href="/how-it-works">See how it works <Arrow /></Link></div>
      ...
      <article className="story-panel story-receive" data-reveal>
        <div className="story-copy"><span className="step-number">03 / VERIFY & RECEIVE</span><h2>Proof in.<br />Crypto out.</h2><p>Upload the original receipt email.<br />Verify your payment, then claim<br />your crypto to your wallet.</p><Link className="veya-button" href="/market">Take a look <Arrow /></Link></div>
    ...
    <section className="veya-close" data-reveal><p className="eyebrow">A new way, starting here.</p><h2>Meet your<br />next move.</h2><Link className="veya-button" href="/market">Explore the testnet <Arrow /></Link><p className="testnet-note">Stellar testnet · Test tokens, real bank transfers.</p><div className="closing-wordmark" aria-hidden="true">veya<span><ArrowMark /></span></div></section>
