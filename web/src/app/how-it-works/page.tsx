  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      ...
      <ol className="space-y-6">
        ...
        <Step n={4} title="Ziraat e-mails a DKIM-signed receipt">The bank&apos;s e-dekont e-mail is signed with Ziraat&apos;s RSA key (DKIM, the standard every mail provider checks). The e-dekont attachment is inside the signed body, so it cannot be altered without breaking the signature.</Step>
