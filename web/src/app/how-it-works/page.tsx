  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      ...
      <ol className="space-y-6">
        ...
        <Step n={3} title="The buyer pays by FAST and declares it">A normal instant transfer from a Ziraat account, with a short payment reference in the description that ties the payment to the buyer&apos;s wallet. Declaring the payment on-chain freezes the reservation for 2 hours: nobody but the buyer can release it.</Step>
        <Step n={4} title="Ziraat e-mails a DKIM-signed receipt">The bank&apos;s e-dekont e-mail is signed with Ziraat&apos;s RSA key (DKIM, the standard every mail provider checks). The e-dekont attachment is inside the signed body, so it cannot be altered without breaking the signature. The buyer drops the downloaded .eml (Gmail: Show original → Download original) on the reservation page; the e-mail goes to the prover only.</Step>
