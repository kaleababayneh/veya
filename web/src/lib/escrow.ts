...
export const ERROR_HELP: Record<string, string> = {
  ...
  IbanMismatch: "The payment in your statement went to a different IBAN than the seller's.",
  AmountTooLow: "The payment in your statement is smaller than the offer amount.",
